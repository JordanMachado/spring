...
export default class ParticleSystem extends THREE.Object3D {
    constructor(renderer) {
        ...
        let points = THREE.GeometryUtils.randomPointsInGeometry(geo, this.data.length / 3);
        ...
        var uvs = new Float32Array( width * height * 2 );
        ...
        this.textureData = new THREE.DataTexture(this.data, width, height, THREE.RGBAFormat, THREE.FloatType);
